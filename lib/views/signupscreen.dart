            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration :InputDecoration(hintText: 'Enter Username' , labelText: "Username"  , prefixIcon: Icon(Icons.person)),
                ),),
                SizedBox(
                  height: 20,
                ),
                ...
                margin: EdgeInsets.symmetric(horizontal:30.0),
                child: TextFormField(
                  decoration :InputDecoration(hintText: 'ReEnter Password ' , labelText: "Confirm Password" , prefixIcon: Icon(Icons.password), suffixIcon: Icon(Icons.visibility)),
                ),),
                ...
                ElevatedButton(onPressed: () async {
                 ...
                 await  FirebaseAuth.instance.createUserWithEmailAndPassword(email: userEmail, password: userPassword).then((value) => { 
                    print("user Created"), signUpUser(userName , userEmail , userPassword),
                    });
